  ...
  <main class="page_body" style="background-color: #283b9c; padding-right: 20px; min-height: 100vh;">
    ...
    <div><?= $_SESSION['message'] ?></div>
        ...
        <?php } else { ?>
            ...
            <h2 style="font-size:50px;">Read List</h2>
            ...
            <h2 style="font-size:50px;">Liked List</h2>
            ...
            $result = $mysqli->query("SELECT * FROM cchilderDB2.User_has_LikedIssue
                INNER JOIN cchilderDB2.Issues ON User_has_LikedIssue.issueID = Issues.issueID WHERE userID='$userID'");
            ...
            if($result->num_rows > 0 ){ // if one or more rows are returned do following
            	...
            	<div>
               <?php 
            $result = $mysqli->query("SELECT * FROM cchilderDB2.User_has_LikedVolume
                INNER JOIN cchilderDB2.Volumes ON User_has_LikedVolume.volumeID = Volumes.volumeID WHERE userID='$userID'");
            ...
            $result = $mysqli->query("SELECT * FROM cchilderDB2.User_has_LikedCreator
                INNER JOIN cchilderDB2.Creators ON User_has_LikedCreator.creatorID = Creators.creatorID WHERE userID='$userID'");
            ...
            $result = $mysqli->query("SELECT * FROM cchilderDB2.User_has_LikedCharacter
                INNER JOIN cchilderDB2.Characters ON User_has_LikedCharacter.characterID = Characters.characterID WHERE userID='$userID'");
