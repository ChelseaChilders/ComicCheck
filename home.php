  ...
  <main class="page_body" style="background-color: #283b9c; padding-right: 20px; min-height: 100vh;">
    ...
    <div><?= $_SESSION['message'] ?></div>
        ...
        if (isset($_POST['search'])) {
            ...
            WHERE (`title` LIKE '%".$search."%') OR (`desc` LIKE '%".$search."%') LIMIT 0, 25");
            ...
            if($result->num_rows > 0 ){ // if one or more rows are returned do following
                ...
                WHERE (`name` LIKE '%".$search."%') OR (`desc` LIKE '%".$search."%') LIMIT 0, 25");
        ...
        <?php } else { ?>
            ...
            $result = $mysqli->query("SELECT * FROM Issues LIMIT 0, 25");
            ...
            if($result->num_rows > 0 ){ // if one or more rows are returned do following
               ...
               $result = $mysqli->query("SELECT * FROM Volumes LIMIT 0, 25");
            ...
            if($result->num_rows > 0 ){ // if one or more rows are returned do following
                ...
                $result = $mysqli->query("SELECT * FROM Creators LIMIT 0, 25");
            ...
            if($result->num_rows > 0 ){ // if one or more rows are returned do following
                ...
                $result = $mysqli->query("SELECT * FROM Characters LIMIT 0, 25");
